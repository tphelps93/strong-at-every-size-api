...
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (1, 'http://dummyimage.com/130x147.png/dddddd/000000', 'Maryanne Errey', 'merrey0', 'uizTm0G59', 'merrey0@jiathis.com', '3 Hazelcrest Street', 'TX', '78769', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (2, 'http://dummyimage.com/220x216.png/ff4444/ffffff', 'Aidan Severn', 'asevern1', 'kbFImsPk', 'asevern1@yolasite.com', '9676 1st Hill', 'NE', '68124', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (3, 'http://dummyimage.com/249x185.bmp/ff4444/ffffff', 'Ruth Deacon', 'rdeacon2', 'Yq6Z0O6xl3', 'rdeacon2@jugem.jp', '34210 Wayridge Road', 'MA', '01152', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (4, 'http://dummyimage.com/197x100.bmp/5fa2dd/ffffff', 'Udale Smellie', 'usmellie3', 'BfWCwdlNGH3', 'usmellie3@cargocollective.com', '82285 7th Parkway', 'WV', '25356', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (5, 'http://dummyimage.com/120x139.png/ff4444/ffffff', 'Vinnie Crowest', 'vcrowest4', 'P2lOXJ5zM', 'vcrowest4@about.me', '5248 Londonderry Crossing', 'GA', '30328', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (6, 'http://dummyimage.com/157x145.bmp/ff4444/ffffff', 'Nelle Hasser', 'nhasser5', '82daRxrhCDb', 'nhasser5@cornell.edu', '7 Dapin Plaza', 'IL', '62718', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (7, 'http://dummyimage.com/121x187.png/ff4444/ffffff', 'Antin Matzke', 'amatzke6', '7YoWfQZ', 'amatzke6@census.gov', '9 Forest Run Parkway', 'PA', '19120', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (8, 'http://dummyimage.com/178x210.bmp/dddddd/000000', 'Annamarie Rolph', 'arolph7', 'DsvvQe2R', 'arolph7@ft.com', '78 Cascade Circle', 'CA', '92835', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (9, 'http://dummyimage.com/102x163.png/cc0000/ffffff', 'Tiebout Kingsford', 'tkingsford8', 'rdoYjaLAF', 'tkingsford8@deliciousdays.com', '56 Ohio Plaza', 'NM', '87190', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (10, 'http://dummyimage.com/162x111.png/5fa2dd/ffffff', 'Delila Kattenhorn', 'dkattenhorn9', 'u0IhStMfEZUk', 'dkattenhorn9@acquirethisname.com', '53 Sutherland Junction', 'TX', '78405', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (11, 'http://dummyimage.com/111x143.jpg/dddddd/000000', 'Lorita Hughman', 'lhughmana', 'eDbwPaDwj', 'lhughmana@umn.edu', '25984 6th Trail', 'FL', '32123', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (12, 'http://dummyimage.com/100x133.jpg/5fa2dd/ffffff', 'Shelden Tippler', 'stipplerb', 'nF1t7hI', 'stipplerb@spiegel.de', '75446 Cambridge Circle', 'VA', '22225', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (13, 'http://dummyimage.com/101x103.bmp/dddddd/000000', 'Kirsten Tregiddo', 'ktregiddoc', 'L1iwDz', 'ktregiddoc@china.com.cn', '6 Valley Edge Hill', 'WA', '98121', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (14, 'http://dummyimage.com/214x135.jpg/5fa2dd/ffffff', 'Uriah Yakolev', 'uyakolevd', 'bB0f6O6Oqu', 'uyakolevd@senate.gov', '0321 Moland Junction', 'CA', '95173', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (15, 'http://dummyimage.com/158x114.jpg/5fa2dd/ffffff', 'Rana Greet', 'rgreete', 'TfdKFbg64NvD', 'rgreete@csmonitor.com', '9522 Marcy Drive', 'TX', '78470', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (16, 'http://dummyimage.com/240x197.png/dddddd/000000', 'Arlie Snookes', 'asnookesf', 'ipGG2DmZjK', 'asnookesf@dmoz.org', '9946 Blaine Park', 'MI', '48098', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (17, 'http://dummyimage.com/164x139.bmp/5fa2dd/ffffff', 'Virginia Kissell', 'vkissellg', 'jG08fA3C', 'vkissellg@soup.io', '0 Blackbird Plaza', 'IL', '60193', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (18, 'http://dummyimage.com/230x232.bmp/cc0000/ffffff', 'Kathie Gaymer', 'kgaymerh', 'AVbo8yWxzyjn', 'kgaymerh@telegraph.co.uk', '2 Ilene Terrace', 'LA', '71161', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (19, 'http://dummyimage.com/166x237.bmp/ff4444/ffffff', 'Petr Pulley', 'ppulleyi', '0y3t8FBRG', 'ppulleyi@marriott.com', '19305 Havey Center', 'AZ', '85311', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (20, 'http://dummyimage.com/159x173.png/5fa2dd/ffffff', 'Brett Haldon', 'bhaldonj', 'IR0tktEAE', 'bhaldonj@livejournal.com', '6112 Waubesa Junction', 'PA', '17405', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (21, 'http://dummyimage.com/101x193.png/ff4444/ffffff', 'Aundrea Boosey', 'abooseyk', 'sPsAw7ZueoU', 'abooseyk@ezinearticles.com', '06821 Village Plaza', 'MS', '39216', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (22, 'http://dummyimage.com/175x198.jpg/ff4444/ffffff', 'Rebekah Kinder', 'rkinderl', 'mip4S5', 'rkinderl@marriott.com', '2 Forest Way', 'PA', '15235', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (23, 'http://dummyimage.com/202x139.bmp/dddddd/000000', 'Derby Gorman', 'dgormanm', 'aHj6F2dzhldk', 'dgormanm@nhs.uk', '27742 Lyons Center', 'TX', '79605', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (24, 'http://dummyimage.com/124x183.jpg/ff4444/ffffff', 'Kara-lynn Hart', 'khartn', 'ICN4KzRgrpPf', 'khartn@w3.org', '41 Springview Hill', 'AZ', '85020', false);
insert into saes_users (user_id, photo, name, user_name, password, email, address, state, zip, isAdmin) values (25, 'http://dummyimage.com/100x225.jpg/dddddd/000000', 'Bunni Blackborn', 'bblackborno', 'A6TofEXu', 'bblackborno@merriam-webster.com', '440 Bunker Hill Park', 'CO', '80045', false);
...
insert into user_purchases (purchase_id, title, price, category, itemId, userId, programId) values (1, 'quis turpis', '$4.64', 'Apparel', 1, 7, null);
insert into user_purchases (purchase_id, title, price, category, itemId, userId, programId) values (2, 'ante vestibulum', '$3.29', 'Apparel', 2, 9, null);
insert into user_purchases (purchase_id, title, price, category, itemId, userId, programId) values (3, 'at nibh', '$2.63', 'Apparel', 3, 21, null);

insert into user_purchases (purchase_id, title, price, category, itemId, userId, programId) values (4, 'in', '$8.22', 'Programs', null, 20, 1);
insert into user_purchases (purchase_id, title, price, category, itemId, userId, programId) values (5, 'pede', '$2.05', 'Programs', null, 21, 2);
...
/* user_reviews */
insert into user_reviews (review_id, content, rating, itemId, programId, userId, date_created) values (1, 'Comfortable!', 5, 5, null, 6, '11/11/2020');
insert into user_reviews (review_id, content, rating, itemId, programId, userId, date_created) values (2, 'Not comfortable at all!', 3, 4, null, 5, '11/11/2020');
insert into user_reviews (review_id, content, rating, itemId, programId, userId, date_created) values (3, 'Awesome!', 5, 6, null, 4, '11/11/2020');

insert into user_reviews (review_id, content, rating, itemId, programId, userId, date_created) values (4, 'In love!', 5, null, 3, 3, '11/11/2020');
insert into user_reviews (review_id, content, rating, itemId, programId, userId, date_created) values (5, 'My daughter loved it!', 4, null, 5, 2, '11/11/2020');
